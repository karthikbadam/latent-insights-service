...
from latent_insights.core.parsing import parse_scout_response
...
class Scout(Agent):
    """Discovers interesting analytical questions from a dataset."""
...
"""
    ...
    def call(
        ...
        if session_db is not None:
            exploration_data = self._run_exploratory_queries(session_db, table_name)
    ...
    def _run_exploratory_queries(self, session_db, table_name: str) -> str:
